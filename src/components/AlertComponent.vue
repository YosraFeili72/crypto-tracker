<template>
  <div
      v-if="isOpen && isAlert"
      class="fixed w-full top-5 lg:w-[calc(100%-460px)] w-full rounded-t-xl flex justify-between items-center p-5
       text-blue-800 border-t-4 border-blue-300 bg-blue-100/90"
      :class="setStatus()"
      role="alert">
    <div>
      <p
